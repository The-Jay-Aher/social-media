						...
						<div className='announcement-container'>
							...
							<div className='announcement active'>
								...
								<div className='announcement-text'>
									We are excited to announce the launch of our latest product - the SmartWatch 3000!
									It comes with all the features you love plus some new ones that will blow your mind.
									Order now and get a special launch discount!
								</div>
